    ...
    <div class="page">
      ...
      <div class="section final-block">
        <div class="terms" style="margin-bottom:14px;">
          By signing this form, you confirm the client, phone, email, and device information above is correct and authorize GADGETBOY LLC to diagnose and/or repair your device. Repairs are performed to the best of our ability but are not guaranteed beyond the stated warranty. A diagnostic assessment will be completed prior to repairs, and a non-refundable diagnostic fee of $25 or $50, depending on the service required, may be charged at drop-off. Additional costs will be communicated and must be approved before work continues. If an ordered part for which payment was collected does not resolve the diagnosed issue or cannot be used to complete the repair, the amount paid for that part may be refunded. The separately charged diagnostic fee remains non-refundable and is not included in the part refund. You are responsible for backing up all data; GADGETBOY LLC is not liable for data loss or incidental access to personal files. Certain repairs, including liquid or severe board damage, may not restore full functionality, and pre-existing issues may worsen. Customer-supplied or third-party parts are installed at your risk and are not warrantied. All repairs include a 90-day limited warranty from the completion date, covering only the specific repair performed. The warranty does not cover unrelated issues, software problems, physical or liquid damage, or devices tampered with after service. Full payment is due at pickup. Devices must be collected within 7 days of completion or will incur a $25/day storage fee. Any device left unclaimed 45 days after completion becomes the property of GADGETBOY LLC.
        </div>
        <div class="sig-row">
