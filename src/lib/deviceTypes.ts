...
export const deviceTypes: DeviceTypeDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'battery', label: 'Battery', type: 'select', options: ['Standard battery','New battery','Other'] },
  ...
  },
  {
    ...
    label: 'Tablet',
    fields: [
      { key: 'size', label: 'Screen Size', type: 'select', options: ['7"','8"','10.2"','10.5"','10.9"','11"','12.9"','13"','14.6"'] },
      ...
      { key: 'color', label: 'Color', type: 'select', options: ['Black','White','Gray','Space Gray','Silver','Gold','Blue','Green','Purple','Pink','Starlight'] },
    ],
  },
  {
    type: 'Console',
    label: 'Console',
    fields: [
      { key: 'model', label: 'Model', type: 'select', options: ['PS5','PS4','Xbox Series X','Xbox Series S','Xbox One','Nintendo Switch','Switch OLED','Switch Lite'] },
      { key: 'storage', label: 'Storage', type: 'select', options: ['None','32 GB','64 GB','500 GB','1 TB','2 TB'] },
