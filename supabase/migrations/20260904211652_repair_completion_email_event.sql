...
begin
  ...
  if p_event_type not in ('diagnostic-intake', 'part-awaiting-delivery', 'repair-completed', 'in-stock-sale', 'consultation-scheduled', 'consultation-updated') then raise exception 'Unsupported automatic email event'; end if;
